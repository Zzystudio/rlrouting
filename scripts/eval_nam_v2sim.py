...
用法: python3 scripts/eval_nam_v2sim.py [num_trajectories=16] [model_dir=l05_nam]
"""
import json
import math
import os
...
OUT_JSON = 'benchmark/routed/v2sim_nam_fidelity.json'
...
for fname in circuits:
    ...
    if sab is None:
        ...
        sab = {'model_dir': 'SABRE', 'circuit': fname,
